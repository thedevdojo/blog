<x-layouts.marketing>
    ...
    <article class="relative w-full h-auto mx-auto prose-sm prose md:prose-2xl">
        <div class="py-6 mx-auto heading md:py-12 lg:w-full md:text-center">
            ...
            <div class="flex flex-col items-center justify-center mt-4 mb-0">
                <h1 class="!mb-0 font-sans text-4xl font-bold heading md:text-6xl md:leading-tight">
                    {{ $post->title }}
                </h1>
            </div>
            ...
            <div class="flex items-center justify-center mt-4 text-left">
                <div class="max-w-full -mt-5 text-lg text-gray-600 whitespace-pre-line">
                    {!! $post->body !!}
                </div>
            </div>
        </div>
